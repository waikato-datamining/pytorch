...
* Pull and run image (adjust volume mappings `-v`):
  ...
  docker run \
    ...
    -it harbor.cms.waikato.ac.nz/public/pytorch/pytorch-yolov7:2022-10-08_cpu
  ```
...
* Push
  ...
  ```bash
  docker push harbor.cms.waikato.ac.nz/public/pytorch/pytorch-yolov7:2022-10-08_cpu
  ```
