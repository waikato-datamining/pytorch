...
* Tag
  ...
  docker tag \
    ...
    harbor.cms.waikato.ac.nz/public/pytorch/pytorch-sam-hq:2023-08-17-1_cuda11.6
  ```
  
* Push

  ```bash
  docker push harbor.cms.waikato.ac.nz/public/pytorch/pytorch-sam-hq:2023-08-17-1_cuda11.6
  ```
