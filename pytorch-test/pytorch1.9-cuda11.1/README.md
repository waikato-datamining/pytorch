...
* Tag
  ...
  docker tag \
    ...
    harbor.cms.waikato.ac.nz/public/pytorch/pytorchtest:pytorch1.9-cuda11.1
  ```
  
* Push

  ```bash
  docker push harbor.cms.waikato.ac.nz/public/pytorch/pytorchtest:pytorch1.9-cuda11.1
  ```
