...
* Launch docker container and execute the script
  ...
  docker run \
    ...
    -it harbor.cms.waikato.ac.nz/public/pytorch/pytorchtest:pytorch1.8.1-cuda11.1 \
    /usr/bin/pytorchtest
  ```
...
* Tag
  ...
  docker tag \
    ...
    harbor.cms.waikato.ac.nz/public/pytorch/pytorchtest:pytorch1.8.1-cuda11.1
  ```
  
* Push

  ```bash
  docker push harbor.cms.waikato.ac.nz/public/pytorch/pytorchtest:pytorch1.8.1-cuda11.1
  ```
