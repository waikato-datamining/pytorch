...
def predict_on_images(model, device, input_dir, output_dir, tmp_dir=None,
...
def main(args=None):
    ...
    predict_on_images(parsed.model, parsed.device, parsed.prediction_in, parsed.prediction_out, tmp_dir=parsed.prediction_tmp,
