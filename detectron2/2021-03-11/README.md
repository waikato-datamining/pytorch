...
Uses [Detectron2](https://github.com/facebookresearch/detectron2) ([documentation](https://detectron2.readthedocs.io/)). 

Uses PyTorch 1.8, CUDA 10.1 and Detectron2 2021-03-11.
...
```
083a70b98959f59cd9ec6960fabd655deaabd742
```
