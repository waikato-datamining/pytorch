...
def load_model(model_path=None, model_config=None):
    """
    Loads and returns the SAM2 predictor to use for inference.

    :param model_path: the model to load, uses pretrained resunet101 if None
    :type model_path: str
    :param model_config: the config file for the model
    :type model_config: str
    :return: the predictor
    :rtype: SAM2ImagePredictor
    """
    sam2_model = build_sam2(model_config, model_path, device="cpu")
    result = SAM2ImagePredictor(sam2_model)
