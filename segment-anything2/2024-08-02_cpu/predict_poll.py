...
def predict_on_images(model_file, model_config, input_dir, output_dir, tmp_dir=None,
    ...
    model_instance = load_model(model_file, model_config)
...
def main(args=None):
    ...
    predict_on_images(parsed.model, parsed.config, parsed.prediction_in, parsed.prediction_out, tmp_dir=parsed.prediction_tmp,
