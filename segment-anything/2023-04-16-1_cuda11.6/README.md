...
* Pull and run image (adjust volume mappings `-v`):
  ...
  docker run \
    ...
    -it harbor.cms.waikato.ac.nz/public/pytorch/pytorch-sam:2023-04-16-1_cuda11.6
  ```
...
* Tag
  ...
  docker tag \
    ...
    harbor.cms.waikato.ac.nz/public/pytorch/pytorch-sam:2023-04-16-1_cuda11.6
  ```
  
* Push

  ```bash
  docker push harbor.cms.waikato.ac.nz/public/pytorch/pytorch-sam:2023-04-16-1_cuda11.6
  ```
